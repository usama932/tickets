  ...
  public function register(Request $request)
  {
    ...
    $creer = date('Y-m-d H:i:s');
       ...
       if(!empty($id_requete))
       {
        ...
        ->select('id')
        ->where('trajet','=',DB::raw("'$trajet'"))
        ->where('depart_name','=',DB::raw("'$depart_name'"))
        ->where('destination_name','=',DB::raw("'$destination_name'"))
        ->where('id_conducteur','=',DB::raw("'$id_conducteur'"))
        ->where('id_user_app','=',DB::raw("'$id_user_app'"))
        ->where('latitude_depart','=',DB::raw("'$latitude_depart'"))
        ->where('longitude_depart','=',DB::raw("'$longitude_depart'"))
        ->where('latitude_arrivee','=',DB::raw("'$latitude_arrivee'"))
        ->where('longitude_arrivee','=',DB::raw("'$longitude_arrivee'"))
        ->where('distance','=',DB::raw("'$distance'"))
        ->where('creer','=',DB::raw("'$creer'"))
        ->where('montant','=',DB::raw("'$cu'"))
        ->where('duree','=',DB::raw("'$duree'"))
        ->where('id_payment_method','=',DB::raw("'$id_payment_method'"))
        ->get();
