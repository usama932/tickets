...
class UserLicenceController extends Controller
{
  ...
  public function updateUserLicence(Request $request)
  {
        ...
        $updatedata = DB::update('update tj_conducteur set statut_licence = ? ,photo_licence = ?,photo_licence_path = ?,modifier = ? where id = ?',['uploaded',$image,$filename,$date_heure,$id_user]);
