        ...
        if ($user_cat == "user_app") {
            ...
            if (empty($image)) {
                ...
                $updatedata = DB::update(
                    "update tj_user_app set photo = ?,photo_path = ?,modifier = ? where id = ?",
                    [$image, $filename, $date_heure, $id_user]
                );
            ...
            if (empty($image)) {
                ...
                $updatedata = DB::update(
                    "update tj_conducteur set photo = ?,photo_path = ?,modifier = ? where id = ?",
                    [$image, $filename, $date_heure, $id_user]
                );
                        ...
                        if ($row->photo_car_service_book_path != "") {
                            if (
                                file_exists(
                                    "assets/images/driver" .
                                        "/" .
                                        $row->photo_car_service_book_path
                                )
                            ) {
                                $image_car =
                                    asset("assets/images/driver") .
