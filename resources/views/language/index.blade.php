                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="userlist-topsearch d-flex mb-3">
                            ...
                            <a class="nav-link" href="{!! route('language.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.language_create')}}</a>
                            </div>
                            ...
                            <table id="example24" class="display nowrap table table-hover table-striped table-bordered table table-striped" cellspacing="0" width="100%">
                                ...
                                <tbody id="append_list12">
                                    @foreach($language as $customer)
                                        <tr>
                                        @if (file_exists('assets/images/flags'.'/'.$customer->flag) && !empty($customer->flag))
                                        ...
                                        <td class="action-btn"><a href="{{route('language.edit', ['id' => $customer->id])}}"><i class="fa fa-edit"></i></a><a id="'+val.id+'" class="do_not_delete" name="user-delete" href="{{route('language.delete', ['id' => $customer->id])}}"><i class="fa fa-trash"></i></a>
