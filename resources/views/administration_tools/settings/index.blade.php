                        ...
                        <div class="row restaurant_payout_create">
                            <div class="restaurant_payout_create-inner">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-50">
                                        <label class="col-3 control-label">{{trans('lang.driver_radios')}}</label>
                                        <div class="col-7">
                                    ...
                                    <div class="form-group row width-50">
										...
										<input type="file"  class="col-7" name="app_logo" id="app_logo" onchange="readURL(this);">
										<div id="image_preview" style="padding-left: 15px;">
										@if (file_exists('assets/images/'.$setting->app_logo) && !empty($setting->app_logo))
                                            <img class="rounded" id="uploding_image" style="width:50px" src="{{asset('assets/images/').'/'.$setting->app_logo}}" alt="image">
                                        @else
	                                        <img class="rounded" id="uploding_image" style="width:50px" src="{{asset('assets/images/logo-placeholder-image.png')}}" alt="image">
                                        @endif
										</div>
									</div>
									...
									<div class="form-group row width-50">
										...
										<input type="file"  class="col-7" name="app_logo_small" id="app_logo_small" onchange="readURL2(this);">
										<div id="image_preview2" style="padding-left: 15px;">
										@if (file_exists('assets/images/'.$setting->app_logo_small) && !empty($setting->app_logo_small))
                                            <img class="rounded" id="uploding_image2" style="width:50px" src="{{asset('assets/images/').'/'.$setting->app_logo_small}}" alt="image">
                                        @else
	                                        <img class="rounded" id="uploding_image2" style="width:50px" src="{{asset('assets/images/logo-placeholder-image.png')}}" alt="image">
                                        @endif
										</div>
									</div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row width-100">
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control address_line1" name="map_key"
                                ...
                                <fieldset>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control contact_us_email" name="contact_us_email" id="contact_us_email" value="{{$setting->contact_us_email}}">
                                        </div>
                                        </div>
                                        <div class="form-group row width-50">
                                        <label class="col-3 control-label">{{trans('lang.contact_us_phone')}}</label>
                                        <div class="col-7">
                                            <input type="number" class="form-control contact_us_phone" name="contact_us_phone" id="contact_us_phone" value="{{$setting->contact_us_phone}}">
                                        </div>
                                        </div>
                                        <div class="form-group row width-50">
                                            <label class="col-3 control-label">{{trans('lang.contact_us_address')}}</label>
                                            <div class="col-7">
                                                <textarea class="form-control contact_us_address" rows="3" name="contact_us_address" id="contact_us_address">{{$setting->contact_us_address}}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="col-7">
                                            <input type="text" class="form-control app_version" name="app_version" id="app_version" value="{{$setting->app_version}}">
                                        </div>
                                        </div>
                                        <div class="form-group row width-50">
                                        <label class="col-3 control-label">{{trans('lang.web_version')}}</label>
                                        <div class="col-7">
                                            <input type="text" class="form-control web_version" name="web_version" id="web_version" value="{{$setting->web_version}}">
                                        </div>
                                        </div>
