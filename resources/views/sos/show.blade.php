                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-group">
                                                    ...
                                                    <span>
												@if (file_exists('assets/images/users'.'/'.$sos->user_photo) && !empty($sos->user_photo))
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-group">
                                                    <label for=""
                                                           class="font-weight-bold">{{trans('lang.Image')}}:</label>
                                                    <span>	@if (file_exists('assets/images/driver'.'/'.$sos->driver_photo) && !empty($sos->driver_photo))
														<img class="rounded" style="width:50px"
