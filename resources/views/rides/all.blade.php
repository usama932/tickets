                                ...
                                <table id="example24"
                                    ...
                                    @foreach($rides as $ride)
                                        <tr>
                                            ...
                                            <td><a href="{{route('users.show', ['id' => $ride->user_id])}}">{{ $ride->userPrenom}} {{ $ride->userNom}}</a></td>
                                          ...
                                          {{--  <td class="address-td">{{ $ride->depart_name}}</td>
                                            ...
                                            <?php $montant=floatval($ride->montant);
                                                        $total_price =$montant;
                                                          ...
                                                          ?>
                                            <td>{{$currency->symbole." ".number_format(floatval($total_price),$currency->decimal_digit)}}</span></td>
                                            <td>
