    ...
    <ul id="sidebarnav">
        ...
        <li>
            <a class="" href="{{ route('tokens.index') }}">
                  <i class="mdi mdi-sale"></i>
                  <span class="hide-menu">Add Tokens</span>
              </a>
        </li>
      <li>
        <a class="has-arrow waves-effect waves-dark" class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                <i class="mdi mdi-calendar-check"></i>
                <span class="hide-menu">{{trans('lang.taxi_booking')}}</span>
            </a>
            <ul aria-expanded="false" class="collapse">
                <li><a href="{!! url('rides/all') !!}">{{trans('lang.all')}}</a></li>
                <li><a href="{!! url('rides/new') !!}">{{trans('lang.new')}}</a></li>
                <li><a href="{!! url('rides/confirmed') !!}">{{trans('lang.confirmed')}}</a></li>
                <li><a href="{!! url('rides/onRide') !!}">{{trans('lang.on_ride')}}</a></li>
                <li><a href="{!! url('rides/completed') !!}">{{trans('lang.completed')}}</a></li>
