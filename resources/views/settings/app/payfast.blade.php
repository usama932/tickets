                    ...
                    <div class="restaurant_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control stripe_key" value="{{ $data->merchant_key }}">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class=" col-7 form-control payfast_secret" value="{{ $data->merchant_Id }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class=" col-7 form-control payfast_cancel_url" value="{{ $data->cancel_url }}">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class=" col-7 form-control payfast_notify_url" value="{{ $data->notify_url }}">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class=" col-7 form-control payfast_return_url" value="{{ $data->return_url }}">
