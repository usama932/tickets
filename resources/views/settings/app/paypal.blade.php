                        ...
                        <fieldset>
                            ...
                            @foreach($paypal as $data)
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class=" form-control paypal_app_id" value="{{ $data->app_id }}">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control paypal_secret" value="{{ $data->secret_key }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class=" form-control paypal_username" value="{{ $data->username }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="col-7">
                                        <input type="passwod" class=" form-control paypal_password" value="{{ $data->password }}">
                                        <div class="form-text text-muted">
