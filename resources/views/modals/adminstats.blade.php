                         ...
                         <div class="card-header align-items-center border-0 mt-4">
                             ...
                             <div class="card-toolbar">
                                 ...
                                 <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                     data-kt-menu="true" id="kt_menu_610d480ca1cd6">
                                     <!--begin::Header-->
                                     <div class="px-7 py-5">
                     ...
                     <div class="card card-xl-stretch mb-5 mb-xl-8">
                         ...
                         <div class="card-header border-0 pt-5">
                             <h3 class="card-title align-items-start flex-column">
                                 ...
                                 <span class="text-muted mt-1 fw-bold fs-7">Total Pending: {{ $totalDeposit }}
                                 </span>
                             </h3>
                             <div class="card-toolbar" data-toggle="tooltip" data-placement="top"
                                 data-trigger="hover" title="Click to add a user">
                                 <a href="#" class="btn btn-sm btn-light btn-active-primary"
                                     data-toggle="modal" data-target="#kt_modal_invite_friends">
                                     <!--begin::Svg Icon | path: icons/duotone/Communication/Add-user.svg-->
                                                 ...
                                                 <td>
                                                     <div class="d-flex align-items-center">
                                                         ...
                                                         <div class="d-flex justify-content-start flex-column">
                                                             <a href="#"
                                                                 class="text-dark fw-bolder text-hover-primary fs-6">{{ $deposit->user->name }}</a>
                                                         </div>
                                                     </div>
                                                 </td>
                                                 <td>
                                                     <span
                                                         class="text-muted fw-bold text-muted d-block fs-7">{{ $deposit->amount }}.00</span>
                                                 </td>
                                                 <td>
                                                     <span
                                                         class="text-muted fw-bold text-muted d-block fs-7">{{ $deposit->payment_method }}</span>
                                                 </td>
                                                 <td>
                                                     <span
                                                         class="text-muted fw-bold text-muted d-block fs-7">{{ $deposit->transaction_number }}</span>
                                                 </td>
                                                 <td>
                                                     <div class="d-flex justify-content-end flex-shrink-0">
                                                         <a href="#"
                                                             ...
                                                             data-toggle="modal"
                                                             data-target="#kt_modal_{{ $deposit->id }}">
                                                         ...
                                                         <a href="{{ route('deposit.update', $deposit->id) }}"
                                                             class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                         ...
                                                         <a href="{{ route('deposit.reject', $deposit->id) }}"
                     ...
                     <div class="card card-xl-stretch mb-5 mb-xl-8">
                         ...
                         <div class="card-header border-0 pt-5">
                             <h3 class="card-title align-items-start flex-column">
                                 ...
                                 <span class="text-muted mt-1 fw-bold fs-7">Total Pending: {{ $totWithdraw }}
                                 </span>
                             </h3>
                             <div class="card-toolbar" data-toggle="tooltip" data-placement="top"
                                 data-trigger="hover" title="Click to add a user">
                                 <a href="#" class="btn btn-sm btn-light btn-active-primary"
                                     ...
                                     <!--end::Svg Icon-->Make a Withdrawal
                                 </a>
                             </div>
                         </div>
                         <!--end::Header-->
                                             ...
                                             <tr>
                                                 <td>
                                                     <div class="d-flex align-items-center">
                                                         ...
                                                         <div class="d-flex justify-content-start flex-column">
                                                             <a href="#"
                                                                 class="text-dark fw-bolder text-hover-primary fs-6">{{ $withdrawal->user->name }}</a>
                                                         </div>
                                                     </div>
                                                 </td>
                                                 <td>
                                                     <span
                                                         class="text-muted fw-bold text-muted d-block fs-7">{{ $withdrawal->amount }}.00</span>
                                                 </td>
                                                 <td>
                                                     <span
                                                         class="text-muted fw-bold text-muted d-block fs-7">{{ $withdrawal->payment_method }}</span>
                                                 </td>
                                                 <td>
                                                     <span
                                                         class="text-muted fw-bold text-muted d-block fs-7">{{ $withdrawal->account_number }}</span>
                                                 </td>
                                                 <td>
                                                     <div class="d-flex justify-content-end flex-shrink-0">
                                                         <a href="#"
                                                             class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                                             data-toggle="modal"
                                                             data-target="#kt_modal_m_{{ $withdrawal->id }}">
                                                             <!--begin::Svg Icon | path: icons/duotone/General/Settings-1.svg-->
                                                             <span class="svg-icon svg-icon-3">
                                                                 <svg xmlns="http://www.w3.org/2000/svg"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                                                         ...
                                                         <a href="{{ route('withdrawal.update', $withdrawal->id) }}"
                                                             class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                             <!--begin::Svg Icon | path: icons/duotone/Communication/Write.svg-->
                                                             <span class="svg-icon svg-icon-3">
                                                                 <svg xmlns="http://www.w3.org/2000/svg"
                                                         ...
                                                         <a href="{{ route('withdrawal.reject', $withdrawal->id) }}"
                                                             class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                             <!--begin::Svg Icon | path: icons/duotone/General/Trash.svg-->
                                                             <span class="svg-icon svg-icon-3">
                                                                 <svg xmlns="http://www.w3.org/2000/svg"
