                                    ...
                                    @if(count($drivers) > 0)
                                        @foreach($drivers as $driver)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('driver.show', ['id' => $driver->id])}}">{{ $driver->nom}} {{ $driver->prenom}}</a>
                                                </td>
{{--                                                @if($driver->status_approval == 'approved')--}}
{{--                                                    <td><span class="btn btn-sm btn-success status_approval"--}}
{{--                                                              data-status="disapproved" id="{{ $driver->id}}"--}}
{{--                                                              name="approvalStatus">Approved</span></td>--}}

{{--                                                @else--}}
{{--                                                    <td><span class="btn btn-sm btn-danger status_approval"--}}
{{--                                                              data-status="approved" id="{{ $driver->id}}" href="#"--}}
{{--                                                              name="approvalStatus" value="approved">Disapproved</span>--}}
{{--                                                    </td>--}}
{{--                                                @endif --}}
                                                <td><a href="{{route('driver.documentView', ['id' => $driver->id])}}"><i
                                                            class="fa fa-file-text"></i></a></td>
                                                <td>{{ $driver->email}}</td>
                                                <td>{{ $driver->phone}}</td>
                                                ...
                                                data-toggle="dropdown" data-original-title="View détails"><i
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{route('driver.show', ['id' => $driver->id])}}">View
                                                                détails</a></li>
                                                        <li>
                                                            <a href="{{route('driver.documentView', ['id' => $driver->id])}}">Approved</a>
                                                        </li>
