                  ...
                  <div class="restaurant_payout_create-inner">
                     <fieldset>
                        ...
                        <div class="form-group row width-50">
                           ...
                           <div class="col-7">
                              <input type="file" class="" name="photo_path"
                                 value="{{Request::old('photo_path')}}"
                     ...
                     <fieldset>
                        ...
                        <div class="form-group row width-50">
                           ...
                           <div class="col-7">
                            <input type="text" class="form-control address_line1" name="brand_name" value="{{Request::old('brand')}}">
                        ...
                        <div class="form-group row width-50">
                            ...
                            <div class="col-7">
                               <input type="text" class="form-control model" name="car_category" value="{{Request::old('model')}}">
                               {{-- <select class="form-control model" name="model" id="model">
                               </select> --}}
                               <div class="form-text text-muted">{{trans('lang.car_model_help')}}</div>
                            </div>
