                                ...
                                <div class="card-body d-flex icon-orange">
                                    ...
                                    <div class="card-left">
                                        ...
                                        <h3 class="m-b-0 text-dark font-medium mb-2 total_earning"
                                            id="">{{ $currency->symbole ?? '0'." ".number_format($total_earnings ?? 0,$currency->decimal_digit ?? 0) }}</h3>
                                ...
                                <div class="card-body d-flex icon-orange">
                                    ...
                                    <div class="card-left">
                                        ...
                                        <h3 class="m-b-0 text-dark font-medium mb-2 admin_commission"
                                            id="">{{ $currency->symbole ?? " ".number_format($total_admin_commission ?? 0,$currency->decimal_digit ?? 0) }}</h3>
                                            <input type="number" value="{{$total_admin_commission ?? " "}}"  id="admin_commission" hidden/>
                                        <h5 class="text-dark m-b-0 small">Total Admission Commission</h5>
	                            ...
	                            <a href="{{ route('rides.completed') }}" >
	                                <div class="card-body d-flex icon-orange">
	                                    ...
	                                    <div class="card-left">
	                                        ...
	                                        <h3 class="m-b-0 text-dark font-medium mb-2 admin_commission"
	                                            id="admin_commission">{{ $currency->symbole  ?? ''." ".number_format($today_admin_commission  ?? 0,$currency->decimal_digit  ?? 0) }}</h3>
                    ...
                    tooltips: {
                        callbacks: {
                            label: function (tooltipItems, data) {
                               return data.labels[tooltipItems.index] + ': ' + currency+ parseFloat(data.datasets[0].data[tooltipItems.index]).toFixed(decimal_point);
                            }
                        }
                    }
                }
