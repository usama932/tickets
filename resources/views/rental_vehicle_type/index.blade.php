                        ...
                        <div class="table-responsive m-t-10">
                            <table id="example24"
                                ...
                                <tr>
                                    ...
                                    @if (file_exists('assets/images/type_vehicle_rental'.'/'.$type->image) &&
                                    !empty($type->image))
                                    <td><img class="rounded" style="width:50px"
                                             src="{{asset('my-assets/images/type_vehicle_rental').'/'.$type->image}}" alt="image">
                                    </td>
                                    @else
                                    <td><img class="rounded" style="width:50px"
                                    ...
                                    @endif
                                    <td>{{ $type->libelle}}</td>
                                    <td>{{ $currency->symbole." ".number_format(floatval($type->prix),$currency->decimal_digit)}}</td>
