            ...
            <div class="form-group row width-50">
              ...
              <div class="col-7">
                <input type="file" class="form-control" name="image" onchange="readURL(this);">
                  @if (file_exists('assets/images/type_vehicle_rental'.'/'.$type->image) && !empty($type->image))
                    <img class="rounded" id="uploding_image"  style="width:50px" src="{{asset('my-assets/images/type_vehicle_rental').'/'.$type->image}}" alt="image">
                  @else
